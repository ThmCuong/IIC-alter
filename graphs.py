...
# build model; it contains set of layers ( vgg, or some custom layer)
...
# combine of Conv2d and batch_norm before turn to activation function if it contained
def convolution_layer(x, kernel_size, num_out_channels, activation, batch_norm, is_training, name):
    """
    :param x: input data
    :param kernel_size: convolution kernel size
    :param num_out_channels: number of output channels = number of filters
...
class IICGraph(object):
    ...
    def __architecture_b(self, x, is_training):
        ...
        """
        # layer 1: conv2d + (batch_norm) + maxpooling 
        # Layer2 : conv2d(channel x2) + maxpooling
        # Layer 3: conv2d(filter x2) + maxpooling
        # Layer 4: Conv2d
        # Flatten
